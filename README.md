...
Currently **148 lessons · 2,176 fact-checked MCQs · 889 flashcards · 442 homework problems · 298 worked
...
- **Spawn a Test (Mastery mode)** — build a custom exam from the 2,176-question bank; scope it to *only what you've completed*, your *weak spots*, a topic, or everything; 5/10/20/40 questions. **Mastery mode (default on)** re-queues every wrong answer until you get it right — no casual remembering.
