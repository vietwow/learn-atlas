...
2. **Deepen the existing six** — ✅✅ COMPLETE (iter 99). Every original topic now has a 7th frontier/advanced module,
   ...
   ⏳ MODULE 6 IN PROGRESS. Remaining: lessons (3) From posterior to decisions (MAP, credible intervals, posterior predictive), (4) Computational Bayes (MCMC & variational intuition); then batch-top all Module-6 lessons 8→16 MCQ. Optional: a Beta prior→posterior update viz (new build).
