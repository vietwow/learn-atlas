...
## Now / live queue
- ✅ iter 712: `l-mixture-of-experts` topped to 16 MCQ. ✅ iter 713: **NEW viz llm-moe-router** (123rd — top-k routing, compute/capacity tradeoff; LLM 18/20→19/20). MoE now fully built (lesson+16 MCQ+code+3dd+viz).
