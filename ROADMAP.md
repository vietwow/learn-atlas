...
2. **Deepen the existing six** — ✅✅ COMPLETE (iter 99). Every original topic now has a 7th frontier/advanced module,
   ...
   ✅ iter 621: **batch 14 — ml-naive-bayes 8→16**. ✅ iter 622: **batch 15 — ml-kmeans 8→16** (1-D convergence/assign-update/O(nkd); 4/4/4/4; headless 16; SW →v563).
   ⏳ MCQ runway (15 of 17 done): remaining at 8 MCQs — ML: ensembles, model-selection (2 left). Then a step-back when the runway completes.
