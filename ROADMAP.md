...
**10 topics · 185 lessons (all at the 16 MCQ / 6 cards / 3 examples / 3 homework / 3 deep-dives standard) · 132 visualizations (all embedded) · 299 glossary terms · cross-topic prereq graph · Library references · code exercises.** Last full regression sweep: **iter 770 (184 lessons, 10 topics, errs=0/bad=none, map 862 nodes)**
