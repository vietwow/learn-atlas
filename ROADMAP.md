...
2. **Deepen the existing six** — ✅✅ COMPLETE (iter 99). Every original topic now has a 7th frontier/advanced module,
   ...
   Viz coverage now: PS 24/24, ML 10/10, IT 7/7, algos 23/23, DL 22/22 fully covered; calc 24/25, LA 18/19, LLM 16/19, RL 15/20. 117 widgets. Remaining gaps are conceptual/discussion lessons (LLM eval/safety, RL practical/offline/imitation/frontiers/model-based, calc integration-techniques, la-matrix-derivative-identities) — viz only where genuinely visual.
