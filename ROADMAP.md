...
2. **Deepen the existing six** — ✅✅ COMPLETE (iter 99). Every original topic now has a 7th frontier/advanced module,
   ...
   ✅ iter 669: deep-dives ps-conjugate-priors +3 (exp family, prior strength, conjugacy breaks).
   ⏳ Deep-dive parity remaining: ps-bayesian-decisions, ps-computational-bayes each need 3 deep-dives (one lesson/iter). Then Module 6 matches site standard on EVERY dimension.
