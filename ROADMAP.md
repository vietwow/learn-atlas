...
2. **Deepen the existing six** — ✅✅ COMPLETE (iter 99). Every original topic now has a 7th frontier/advanced module,
   ...
   ✅ iter 685: topped ps-causal-graphs 8→16 MCQ (acyclicity, randomization, front-door, d-sep, IV, …). Both causal lessons now at full parity; all 171 lessons at standard.
   ⏳ Causal thread further (bounded, owner can redirect): a 3rd lesson "Estimating Causal Effects" (RCT/A-B stats, propensity scores, IV, diff-in-diff) — then group the 3 causal lessons into their own PS module "Causal Inference".
