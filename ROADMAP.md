...
2. **Deepen the existing six** — ✅✅ COMPLETE (iter 99). Every original topic now has a 7th frontier/advanced module,
   ...
   ⏳ Top c-duality-kkt 8→16 MCQ (gate parity-warns). Optimization thread could extend (gradient-method convergence rates, proximal/projected methods) if owner wants an Optimization push.
